            ...
            <div className="col-lg-6 mb-6 mb-lg-0">
              <div>
                ...
                <h1 className="display-3 fw-bold mb-3">
                  1 Million Coders Program
                </h1>
                {/* para */}
                <p className="pe-lg-10 mb-5">
                Empowering Ghana's youth with world-class digital skills to unlock opportunities, drive innovation, and transform the nation into a global tech powerhouse.
                </p>
                {/* btn */}
